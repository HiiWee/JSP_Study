    ...
    <table class="table">
      ...
      <tr style="height:600px;outline:1px solid gray;vertical-align:top;">
        <td class="table_content_td">
          ...
          <div style="margin-left: 50px;">
            ...
            <div class="content_div">
              ...
              <label style="line-height:2;border:0px;width:120px;">${sessionScope.pSeatName }</label><br>
            </div>
          </div>
        </td>
        <td style="vertical-align:bottom;">
          ...
          <div class="price_div"><label>상품금액</label><label class="price_div_label"><fmt:formatNumber type="number" pattern=",###" value="${sessionScope.pTotalPrice }"/>원</label></div>
          <div class="price_div"><label>결제금액</label><label class="price_div_label"><fmt:formatNumber type="number" pattern=",###" value="${sessionScope.pTotalPrice }"/>원</label></div>
