...
<body>
    ...
    <c:if test="${ listEmpty }">
        <div
            style=" margin: 200px auto;color:red; font-weight: bold; text-align: center; width: 1000px; font-size: 30px;">
            예약내역이 없습니다.
        </div>
    </c:if>
                    ...
                    <tr style="height:600px;outline:1px solid gray;vertical-align:top;">
                        <td class="table_content_td">
                            ...
                            <div style="margin-left: 50px;">
                                ...
                                <div class="content_div">
                                    ...
                                    <label style="line-height:2;">${fn:substringBefore(Math.ceil(list.totalPrice/14000),
                                        '.')}</label><br>
                        ...
                        <td style="vertical-align:bottom;">
                            ...
                            <div class="price_div"><label>상품금액</label><label class="price_div_label">
                                    <fmt:formatNumber type="number" pattern=",###" value="${list.totalPrice }" />
                                    원</label></div>
