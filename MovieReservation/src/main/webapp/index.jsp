...
<body>
    ...
    <header class="header">
        ...
        <nav class="navigation">
            <a href="#"><img class="homelogo" src="/images/homelogo2.png"></a>
    ...
    <div class="content_div">
        ...
        <div style="text-align: center;">
            <label style="font-size: 30px; color: black;"><b>인기영화</b></label>
        </div>
        <table class="table">
            <tr>
                ...
                <td class="movie_content_td"><img src="/images/Movies/romance_without_love_poster.jpg"
                        class="poster_image"></td>
    ...
    <div class="scheduletorelease_div">
        <label style="font-size: 30px; color: black;"><b>개봉예정 영화</b></label><br>
        <br> <a href="https://www.youtube.com/watch?v=yFZh-Wqi7RI" target="_blank"><img
                src="/images/Movies/spiderman_poster.jpg"></a>
        <a href="https://www.youtube.com/watch?v=yEPgqn5f1uk" target="_blank"><img
                src="/images/Movies/matrix_poster.jpg"></a> <a href="https://www.youtube.com/watch?v=DJs_ihmMZfg"
            target="_blank"><img src="/images/Movies/encanto_poster.jpg"></a>
    </div>
